...
class _AccountPageState extends State<AccountPage> {
  ...
  String get _backgroundImagePath {
    return _isNight ? "assets/images/night_bg.jpg" : "assets/images/day_bg.jpg";
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        final String displayName = user?.displayName ?? "Khách Hàng";
        final String? photoURL = user?.photoURL;

        return Scaffold(
          backgroundColor: Colors.grey[50],
          // Dùng Column để chia màn hình thành 2 phần: Header (cố định) và Body (cuộn)
          body: Column(
            children: [
              // ========================================================
              // PHẦN 1: HEADER (CỐ ĐỊNH - KHÔNG CUỘN)
              // ========================================================
              Container(
                height: 160,
              ...
              // ========================================================
              // PHẦN 2: BODY SCROLL (NẰM DƯỚI HEADER)
              // ========================================================
              Expanded(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          Container(
                              ...
                              // ClipRRect để cắt ảnh theo góc bo tròn
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: Image.asset(
                                  "assets/images/thumbnail_gluco.png", 
                                  fit: BoxFit.cover, 
                                  width: double.infinity,
